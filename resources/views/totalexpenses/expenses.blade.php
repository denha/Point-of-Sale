...
<table class='easyui-datagrid' striped='true' title='Expenses' rowNumbers="true" iconCls='fa fa-table' singleSelect='true' showFooter="true" url='' pagination='true' id='gridpaynow' method='get' fitColumns='true' style='width:100%' toolbar='#customerstoolbar'>
    <thead><tr>
...
$('#excel').click(function(){
    ...
    var date2=$('#date2').val();
    if(date1=='' && date2==''){
        window.location="expenseexcel/xlsx/today/today";
    }
    else if(date1!='' && date2==''){
        window.location="expenseexcel/xlsx/"+date1+"/today";  
    }
    else if(date1!='' && date2!=''){
        window.location="expenseexcel/xlsx/"+date1+"/"+date2;  
    }
