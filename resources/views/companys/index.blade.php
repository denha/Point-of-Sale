...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>POS Printer</label></div><input type='text' class='form-control' name='posprinter' 
 id='posprinter' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Is POS Print ?</label></div>
<select class='easyui-combobox form-control' id="isPrint" name="isPrint" style="width:100%;height:34px;">
...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Barcode Printer Name (Printer shd be shared )</label></div><input type='text' class='form-control' name='printer' 
 id='printer' /></div>
</div>
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Is Barcode Print ?</label></div>
<select class='easyui-combobox form-control' id="isbarcode" name="isbarcode" style="width:100%;height:34px;">
<option value='1'>Yes</option>
<option value='0'>No</option>
</select>
...
<script>
 ...
 $(document).ready(function(){
    ...
    columns:[[
        ...
        {field:'name',width:180,title:'Company Name'},
        ...
        {field:'posprinter', title:'POS Printer',width:80,sortable:true},
        {field:'isPrint', hidden:'true', title:'POS Print',width:80,sortable:true},
        {field:'print',  title:'POS Print',width:80,sortable:true},
        {field:'printer',title:'Barcode Printer',width:90},
        {field:'Bprint',title:'Barcode Print',width:90},
        {field:'isbarcode',title:'Barcode Print',width:90,hidden:'true'},
...
var isbarcode=$('#isbarcode').val();
var isPrint=$('#isPrint').val();
var posprinter=$('#posprinter').val();
...
form_data.append('isPrint',isPrint);
form_data.append('boxno', boxno);
form_data.append('printer',printer);
form_data.append('isbarcode',isbarcode);
form_data.append('posprinter',posprinter);
