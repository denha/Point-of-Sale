    ...
    $.ajax({
        ...
        success: function(data){
			...
			$('#gridaccounttrans').edatagrid({
				...
				url:'/viewnewpurchase/'+$('#purchaseno').val(),
				method:'get',
...
<table class='easyui-datagrid' idField="id" rowNumbers='true' title='Items' iconCls='fa fa-table' singleSelect='true' url='' pagination='true' id='gridaccounttrans' method='get' fitColumns='true' style='width:100%' toolbar='#expensestoolbar'>
	<thead><tr>
