...
foreach($items as $ite){
  ...
  $shoppingCart->addToCart($productResult[0]["id"], 1, $member_id,$ite->sellingrate,2);
...
?>
<input type="text" name="number"  hidden id="number" value="{{$number}}"/>
...
<input  id="transdates" value="{{$det->transdate}}" style="width:56%;height:34px;"    />
...
<label> <b style="color:grey">CASH PAID  :</b></label><input  value="
<?php
  if (! empty($cartItem)) { 
 ...
 ?>
"type="text" id="cashpaid" name="cashpaid" style="width:170px;margin-left:89px;" /><br>
