...
method:'get',
url:'newpurchasereportviews?end='+finend+'&start='+finstart,
...
if(a==null){
    ...
    $.messager.confirm('Confirm','Are you sure you want to Delete this Record',function(r){
        if(r){
            var row=$('#gridcustomers').datagrid('getSelected');
            $.ajax({
             url:'/destorypurexp/'+row.purchaseheaderid,
             method:'POST',
...
$('#excel').click(function(){
    ...
    var date2=$('#date2').val();
    if(date1=='' && date2==''){
        window.location="newpurchaseexcel/xlsx/today/today";
    }
    else if(date1!='' && date2==''){
        window.location="newpurchaseexcel/xlsx/"+date1+"/today";  
    }
    else if(date1!='' && date2!=''){
        window.location="newpurchaseexcel/xlsx/"+date1+"/"+date2;  
    }
