...
<table class='easyui-datagrid'  striped='true' rowNumbers="true" title='Invoices Report' iconCls='fa fa-table' showFooter="true" singleSelect='true' url='' pagination='true' id='gridcustomers'  fitColumns='true' style='width:100%' toolbar='#customerstoolbar'>
<thead><tr>
<th field='invoiceDate' width='100'>Date</th>
<th field='id' width='80'>Purchase #</th>
<th field='suppliername' width='100'>Supplier</th>
<th field='total'  width='80'>TotalAmt</th>
...
<input class="easyui-combobox" id="branche" name="branche" data-options="url:'combobranches',valueField:'id',textField:'branchname',method:'get' "/>-->&nbsp;<a href="javascript:void(0)" class="btn btn-primary"
 ...
 <a href="javascript:void()" class="btn btn-primary" id="editsales"><i class="fa fa-calendar"></i> View</a>&nbsp;
 <a href="javascript:void()" class="btn btn-primary" id="editexpense"><i class="fa fa-calculator"></i> Expense</a>&nbsp;
 <a href="javascript:void()" class="btn btn-primary" id="inventory"><i class="fa fa-gear"></i> Inventory</a>&nbsp;
...
window.location="/editnewpurchase/"+row.id;

       });

       $('#editexpense').click(function(){
        var row=$('#gridcustomers').datagrid('getSelected');
window.location="/invoiceadd/"+row.id;

       });
       $('#inventory').click(function(){
        var row=$('#gridcustomers').datagrid('getSelected');
        window.location="/stockentry/"+row.id;
...
method:'get',
url:'/viewinvoicereports?end='+finend+'&start='+finstart,
