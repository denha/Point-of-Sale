...
<table class='easyui-datagrid' rowNumbers='true' striped='true' title='Profits Per Item' showFooter="true" iconCls='fa fa-table' singleSelect='true'  pagination='true' id='gridcustomers' fitColumns='true' style='width:100%' toolbar='#customerstoolbar'>
<thead><tr>
...
<th field='totalpaid' width='100'>Selling Price</th>
<th field='buyingrate' width='100'>Cost Price</th>
...
<label>Product</label>
<input class="easyui-combobox" id="product" name="product" style="width:20%;" data-options="method:'get',url:'stockscombo/1',valueField:'id',textField:'name'"/>
<!--<label>Branch</label>
