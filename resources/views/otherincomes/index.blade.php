...
<div class='col-lg-6'>
<div class='form-group'>
<div><label>Date</label>&nbsp;&nbsp;&nbsp;<b id="validdate" style="color:red;"> </b></div><div><input  class="easyui-datebox form-control" style="width:100%;height:34px;"  name='transdates' 
...
<div class="col-lg-6">
	<div class="form-group">
		<div><label>Recieving Account</label>&nbsp;&nbsp;&nbsp;<b id="validpayingaccount" style="color:red;"> </b></div>
