...
foreach($items as $ite){
  ...
  $shoppingCart->addToCart($productResult[0]["id"], 1, $member_id,$ite->sellingrate,getQty($ite['id']));
...
<label> <b style="color:grey;">TOTAL COST  :</b></label><input readonly value="
 ...
 ?>"  id="totalcost" type="text" style="width:150px;margin-left:95px;" /><br>
<label> <b style="color:grey;">CASH PAID  :</b></label><input type="text" id="cashpaid" name="cashpaid" style="width:150px;margin-left:109px;" /><br>
<label> <b style="color:grey">BAL  :</b></label><input id="bal" type="text" style="width:150px;margin-left:156px;" />
<h3>No of Items <b id="items" style="float:right;color:red"> <?php echo countItem(); ?></b> </h3>
<br><br><a href="javascript:void()" class="btn btn-primary" style="width:100px;margin-left:240px;" id="save"> save </a>
...
'method':'POST',
'data':{'customer':custo,'transdates':transdates,'bal':bal,'totalcost':totalcost,'purchaseno':purchaseno,'cashpaid':cashpaid,'_token':$('input[name=_token]').val()},
success:function(data){
  window.location='/barcodesales';
  //windows.href="";
