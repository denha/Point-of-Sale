...
<table class='easyui-datagrid'  striped='true' rowNumbers='true' title='Ledger' iconCls='fa fa-table' singleSelect='true' showFooter="true" url="/viewcodeaccount/{{$id}}" pagination='true' id='gridpaynow' method='get' fitColumns='true' style='width:100%' toolbar='#customerstoolbar'>
    <thead><tr>
    <th field='transdates' width='100'>TranscationDate</th>
    <th field='id' width='50'>Ref No.</th>
    <th field='narration' width='300'>Narration</th>
    <th field='debits' width='80'>@if($id==1113)
    Stock In 
    @else
    Debit 
    @endif
    </th>
    <th field='credits' width=80>@if($id==1113)
    Stock Out 
    @else
    Credit 
    @endif</th>
