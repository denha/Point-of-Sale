...
public function view(){
        ...
        $rst =  DB::getPdo()->prepare("select *,if(isbarcode=1,'Yes','No') as Bprint,if(isPrint=1,'Yes','No') as print from companys where id=$bra limit $offset,$rows");
        $rst->execute();
...
$Objcompanys->printer=$request['printer'];
$Objcompanys->posprinter=$request['posprinter'];
$Objcompanys->isbarcode=$request['isbarcode'];
...
//$Objcompanys->id=$request['id'];
$Objcompanys->name=$request['name'];
$Objcompanys->isPrint=$request['isPrint'];
$Objcompanys->location=$request['location'];
$Objcompanys->boxno=$request['boxno'];
$Objcompanys->phone=$request['phone'];
$Objcompanys->email=$request['email'];
