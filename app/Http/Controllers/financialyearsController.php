...
$yearexpense=DB::select("select sum(if(accounttype=6,amount,0))-sum(if(accounttype=7,if(ttype='D',amount,-amount),0)) as totalincome from yearexpenses where transdate between '$clo->startperiod' AND '$clo->endperiod' and bracid=$bra ");
